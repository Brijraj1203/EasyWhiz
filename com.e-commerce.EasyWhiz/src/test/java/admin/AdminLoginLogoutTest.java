...
public class AdminLoginLogoutTest extends BaseClass{
	@Test(retryAnalyzer = genericUtilities.RetryAnalyzerImpClass.class, priority=1)
	public void adminLoginLogoutTest() throws IOException, InterruptedException {
...
//		if(adminLoginPage.getLogoutSuccesfulMsg().isDisplayed())
...
//			Reporter.log("Fail: Logout Succesful message is not displayed",true);
		...
		Assert.assertTrue(adminLoginPage.getLogoutSuccesfulMsg().isDisplayed());
		Reporter.log("Pass: Logout Succesful message is displayed",true);
		
		

	}
	@Test(retryAnalyzer = genericUtilities.RetryAnalyzerImpClass.class, priority=2)
...
//		opt.addArguments("--headless");
	...
	@Test(retryAnalyzer = genericUtilities.RetryAnalyzerImpClass.class, priority=3)
...
//			Reporter.log("Fail",true);
		...
		Assert.assertEquals(status2, statusChangeTo);
		Reporter.log("Pass: Status change Verified",true);
